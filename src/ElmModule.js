...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{current_position: 0.0, input_field: '6Af6b_wyiwI', state: $author$project$Main$Fresh},
...
var $author$project$Main$extract_information = function (node) {
	if (((((((node.$ === 'Element') && node.b.b) && node.b.b.b) && (!node.b.b.b.b)) && node.c.b) && (node.c.a.$ === 'Text')) && (!node.c.b.b)) {
		...
		return {
			content: A3($elm$core$String$replace, '&#39;', '\'', cue_text) + ' ',
				...
				if (_v1.$ === 'Loading_YT') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								state: $author$project$Main$Loading_Cues(video_id)
							}),
						...
						if (_v4.$ === 'Nothing') {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: A3($author$project$Main$Received, cues, id, $author$project$Main$No)
									}),
								$elm$core$Platform$Cmd$none);
						}
					} else {
			...
			case 'Validate_And_Fetch':
				...
				switch (_v9.$) {
					...
					case 'Loading_YT':
						...
						return $author$project$Main$doNothing(model);
					default:
						var _v10 = $author$project$Main$validate_id(model.input_field);
						if (_v10.$ === 'Ok') {
							var video_id = _v10.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										state: $author$project$Main$Loading_YT(video_id)
									}),
...
var $author$project$Main$create_cue_span = F3(
	function (index, cue, highlight) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(cue.content)
				]));
	});
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$core$List$indexedMap,
							A2($author$project$Main$generate_html_from_cue, model.current_position, edit),
							cues))
					]));
	}
};
