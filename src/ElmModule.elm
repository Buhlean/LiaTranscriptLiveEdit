import Browser
import Html exposing (Html, text, div, input, button, span, b, img)
...
tooltip_button = img (common_style_top++
  [ A.src "https://raw.githubusercontent.com/Buhlean/LiaTranscriptLiveEdit/master/assets/info.png" --CC
