...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{A: 0.0, C: '5p-SsuTm130', f: $author$project$Main$Fresh},
...
var $author$project$Main$fetch_transcript = function (video_id) {
	return $elm$http$Http$get(
		{
			aX: $elm$http$Http$expectString($author$project$Main$GotAnswer),
		...
		switch (msg.$) {
			case 3:
				...
				if (_v1.$ === 4) {
					...
					if (!result.$) {
						...
						var _v3 = $author$project$Main$parse_xml(fullText);
						if (_v3.$ === 1) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{f: $author$project$Main$XML_Invalid}),
								$elm$core$Platform$Cmd$none);
						} else {
							var cues = _v3.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										f: A3($author$project$Main$Received, cues, id, $author$project$Main$No)
									}),
								$elm$core$Platform$Cmd$none);
						}
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{f: $author$project$Main$Load_Failed}),
							$elm$core$Platform$Cmd$none);
					}
				} else {
			...
			case 2:
				...
				if (_v7.$ === 4) {
					...
					var _v8 = $author$project$Main$validate_id(model.C);
					if (!_v8.$) {
						var video_id = _v8.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									f: $author$project$Main$Loading(video_id)
								}),
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{f: $author$project$Main$ID_Invalid}),
							$elm$core$Platform$Cmd$none);
					}
				}
			case 1:
...
var $author$project$Main$mod_rem = F2(
	function (a, b) {
		return _Utils_Tuple2(
			(a / b) | 0,
			A2($elm$core$Basics$modBy, b, a));
	});
var $author$project$Main$parseTime = function (time_in_seconds) {
	var _v0 = A2($author$project$Main$mod_rem, time_in_seconds, 3600);
	var hours = _v0.a;
	var hour_rem = _v0.b;
	var _v1 = A2($author$project$Main$mod_rem, hour_rem, 60);
	var minutes = _v1.a;
	var seconds = _v1.b;
	return (hours > 0) ? $elm$core$String$concat(
		_List_fromArray(
			[
				'Jump to: ',
				...
				's'
			])) : ((minutes > 0) ? $elm$core$String$concat(
		_List_fromArray(
			[
				'Jump to: ',
				$elm$core$String$fromInt(minutes),
...
var $author$project$Main$jumpTo_message = function (seconds) {
	return A2(
		$elm$html$Html$span,
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				$author$project$Main$parseTime(seconds))
			]));
};
var $elm$virtual_dom$VirtualDom$lazy2 = _VirtualDom_lazy2;
var $elm$html$Html$Lazy$lazy2 = $elm$virtual_dom$VirtualDom$lazy2;
var $tricycle$elm_embed_youtube$Embed$Youtube$Internal$Attribute$Mute = {$: 6};
var $tricycle$elm_embed_youtube$Embed$Youtube$Attributes$mute = $tricycle$elm_embed_youtube$Embed$Youtube$Internal$Attribute$Mute;
...
var $tricycle$elm_embed_youtube$Embed$Youtube$Internal$View$toYoutubeUrl = function (yt) {
	...
	return {
		...
		af: 'www.youtube-nocookie.com',
		am: '/embed/' + stringYoutubeVideoid,
...
var $author$project$Main$field_and_buttons = F2(
...
var $author$project$Main$unloaded_elements = F2(
	function (model, text) {
		return A2(
			...
			_List_fromArray(
				[
					A2($author$project$Main$field_and_buttons, model, text),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
	...
	switch (_v0.$) {
		...
		default:
			...
			return A2(
				...
				_List_fromArray(
					[
						$tricycle$elm_embed_youtube$Embed$Youtube$toHtml(
						A2(
							...
							_List_fromArray(
								[
									...
									$tricycle$elm_embed_youtube$Embed$Youtube$Attributes$mute
								]),
							$tricycle$elm_embed_youtube$Embed$Youtube$fromString(video_id))),
						A2(
						$elm$html$Html$div,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Main$url_field(model.C),
										$author$project$Main$fetch_button,
										$author$project$Main$jumpTo_message(
										$elm$core$Basics$floor(model.A)),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
											[
